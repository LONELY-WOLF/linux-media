...
namespace LinuxMedia.Rockchip
{
    public class MppBuffer : MppHandle
    {
        ...
        public MppBuffer(MppBufferInfo info, MppBufferGroup? group = null, string? tag = null)
        {
            ...
            MPP_RET r = mpp_buffer_import_with_tag(grp_ptr, ref info, ref Handle, tag);
            if (r != MPP_RET.MPP_OK)
            {
        ...
        internal static extern MPP_RET mpp_buffer_import_with_tag(IntPtr group, ref MppBufferInfo info, ref IntPtr buffer, [MarshalAs(UnmanagedType.LPStr)] string? tag, [CallerMemberName] [MarshalAs(UnmanagedType.LPStr)] string caller = "");
        /// <summary>
